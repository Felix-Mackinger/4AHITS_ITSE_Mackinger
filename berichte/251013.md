...
┌──(kali㉿kali)-[~]
└─$ ./pingScript.sh 192.168.12
192.168.12.50 ist aktiv
192.168.12.51 ist aktiv
192.168.12.52 ist aktiv
192.168.12.254 ist aktiv
```
...
1. Recherchiere zur grundlegenden Anwendung von nmap für einen sogenannten ping scan (host discovery).
    ...
    Ausgabe gibt 6 Antworten am Ende steht das rtt 
